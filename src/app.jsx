...
export default class App extends React.Component {
  ...
  render() {
    ...
    const showResponseOrError = (response, error) => (
      Object.keys(response).length >= 0 ? JSON.stringify(response.json, null, 2) : JSON.stringify(error, null, 2));
            ...
            <div className="query-content-editor pure-g">
              ...
              <div className="query-content-editor-controls pure-u-1-6">
                <button
                  ...
                  onClick={this.handleOnClick}>{this.state.labels.button}</button>
              </div>
            </div>
